...
class CLOPS(BaseLearner):
    ...
    def learn_task(self, task):
        ...
        # Use training dataloader for early stopping (no validation set)
        val_dataloader = Dataloader_from_numpy(x_train, y_train, self.batch_size, shuffle=False)
        ...
        for epoch in range(self.epochs):
            ...
            # Use training set for early stopping
